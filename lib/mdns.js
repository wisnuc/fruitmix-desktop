    ...
    if (prev === null) {
      ...
      request
        ...
        .end((err, res) => {
          ...
          let server = res.body
          let block = this.getBlockMessage(curr.address,(data) => {
      ...
      if (stn.appifi) {
        ...
        request
          ...
          .end((err, res) => {
            ...
            if (err) 
              return this.updateStation({ name: stn.name, appifi: err })

            if (!res.ok)
              return this.updateStation({ name: stn.name, appifi: 'BAD' }) 
            ...
            request
              ...
              .end((err, res) => {
                ...
                if (err || !res.ok)
                  return this.updateStation({name: stn.name, appifi, fruitmix: 'ERROR'})
