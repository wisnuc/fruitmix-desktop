...
// folder task : init -> ready -> running -> success or fail (update children state, reschedule)
// file task: init -> hashing -> ready -> running -> success or fail (update itself state, reschedule)
/**
...
class UserTask {
	constructor(xxx) {
		this.root = new folderUploadTask(xxx)
	}
}
...
class folderUploadTask extends EventEmitter {
  ...
  /** { dev: 1416309614,
    ...
    rdev: 0,
    blksize: undefined,
    ino: 2251799814156057,
    size: 472,
    blocks: undefined,
    atime: 2016-10-27T21:05:24.991Z,
    mtime: 2016-10-27T21:05:24.991Z,
    ctime: 2016-10-27T21:05:24.991Z,
    birthtime: 2016-10-27T21:05:24.991Z,
    abspath: 'xxxx' } **/
    /**
