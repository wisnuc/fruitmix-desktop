...
const DetailPanel = () => {
  ...
  return (
    <Paper style={{backgroundColor: 'blue', width: 200, height: '100%'}} />
  )
}
...
const FileView = () => {
  ...
  let showDetail = window.store.getState().view.toggle
...
/**
  return (
    ...
    >
      <div key = 'file-table'
        style = {{
          width: showDetail ? 'calc(100% - 300px)' : '100%',
          height: '100%',
...
class AllFiles extends Component {
	...
	render() {
		...
		return (
			<div key='file-view' style={{display: 'flex', width:'100%', height: '100%'}}>
				{ this.getTable() }
				{/*file detail*/}
				{/*this.getDetail()*/}
