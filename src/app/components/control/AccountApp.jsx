  ...
  render() {
    ...
    return (
      <div style={{ paddingLeft: 72 }}>
        ...
        {/* user type */}
        <div style={{ fontSize: 14, marginBottom: 20, maxWidth: 750, color: 'rgba(0, 0, 0, 0.87)', lineHeight: '26px' }} >
          {
        ...
        {/* username */}
        <div style={{ fontSize: 24, fontWeight: 400, lineHeight: '42px', color: 'rgba(0, 0, 0, 0.87)' }} > 用户名 </div>
        <div style={{ fontSize: 14, maxWidth: 750, color: 'rgba(0, 0, 0, 0.87)', lineHeight: '26px' }} >
        ...
        {/* password */}
        <div style={{ fontSize: 24, fontWeight: 400, lineHeight: '42px', color: 'rgba(0, 0, 0, 0.87)' }} > 密码 </div>
        <div style={{ fontSize: 14, maxWidth: 750, color: 'rgba(0, 0, 0, 0.87)', lineHeight: '26px' }} >
