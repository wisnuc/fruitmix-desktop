					...
					<Stepper activeStep={stepIndex} orientation="vertical">
						...
						<Step>
							...
							<StepContent>
								...
								<div style={{margin: '20px 0', color: 'rgba(0, 0, 0, 0.87)', fontSize: 16}}>
									模式：<span style={{fontWeight: 'bold', color: 'rgba(0, 0, 0, 0.87)'}}>{this.state.volumeselect.mode}</span>
								</div>
								<div style={{margin: '20px 0', color: 'rgba(0, 0, 0, 0.87)', fontSize: 16}}>
									用户名：<span style={{fontWeight: 'bold', color: 'rgba(0, 0, 0, 0.87)'}}>{this.state.userpass.username}</span>
								</div>
